export const CAPSTONES = {
  block1: {
    ...
    brief: 'A secondary school is considering an AI system that recommends after-school activities using student interests and interaction data. Act as a junior AI adviser and explain how the system should be used responsibly.',
    prompts: [
