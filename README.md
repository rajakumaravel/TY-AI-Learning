...
- Chapter 6, AI for Learning & Work, following Student Book pp. 28–31: AI tutoring and explanation without AI, an eight-step event-budget cleaning workflow in LibreOffice Calc, independent human review, professional editing, disclosure choices and a learning contract; DuckDuckGo AI Chat → unsigned-in Copilot → session samples, with a teacher key kept outside public files
