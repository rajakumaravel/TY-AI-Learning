export const meta = {
  ...
  phases: [{ title: 'Implement', detail: 'three agents in isolated worktrees, disjoint file ownership' }],
}
...
4. Docs: release note, README pilot-features line, ROADMAP current-work pointer.`), { label: 'impl:content', isolation: 'worktree', schema: RESULT }),
...
4. Write tests/${slug}.test.mjs per the contract's standing Tests policy; note which assertions fail only because other agents' files are absent in your worktree.`), { label: 'impl:student-ui', isolation: 'worktree', schema: RESULT }),
