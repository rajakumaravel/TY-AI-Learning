...
export function assessChapterCapstone({blockId,answers={}}){
  ...
  const hasEvidence=/\b(because|evidence|result|8|80|dark|light|background|stakeholder|benefit|risk|example|column|row|field|search|borrow|library|reading)\b/i.test(combined);
