...
- Protected admin/teacher dashboard at `/admin`
...
Admin access is enforced server-side through the `ADMIN_EMAILS` Netlify environment variable or a Netlify Identity `admin` role.
